  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
        <AnimatedText
          text="We are Aeronyx, a web development and automation studio founded by Pranav. We design beautiful, high-speed, and automated digital systems. We help businesses create a strong online presence through custom web development, real-time database integrations, CRM receptionist portals, and structured SEO designs. Our goal is to deliver web products that are visually stunning, user-focused, and built for maximum business automation."
